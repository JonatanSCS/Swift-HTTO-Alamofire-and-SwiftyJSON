...
class POSTViewController: UIViewController, UITextFieldDelegate, UINavigationControllerDelegate,UIImagePickerControllerDelegate, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func sinImagen(){
        var alert = UIAlertController(title: "Sin imagen", message: "Se subirala nueva tshirt sin imagen", preferredStyle: UIAlertControllerStyle.Alert)
    ...
    func alamoPOST(){
        ...
        if imageCamPicker.image == nil {
            ...
            Alamofire.request(.POST, "http://192.168.1.67:3000/tshirt", parameters: parameter, encoding: .JSON).responseJSON{
